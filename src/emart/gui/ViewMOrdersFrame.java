 ...
 * @author vivek
 */
public class ViewMOrdersFrame extends javax.swing.JFrame {

    DefaultTableModel tm;
    public ViewMOrdersFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Select User Id");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(28, 28, 28)
                        .addComponent(jcUserId, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(61, 61, 61)
    ...
    private void jcUserIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcUserIdActionPerformed
        ...
        try
        {  
           List<String> oList= OrdersDAO.getAllOrdersId(jcUserId.getSelectedItem().toString());
           if(oList.isEmpty())
           {
               return;        
           }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewMOrdersFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewMOrdersFrame().setVisible(true);
            }
        });
    }
    ...
    private void loadUserId() {
          try
        {
           List<String> uList= OrdersDAO.getAllUsersId();
           if(uList.isEmpty())
           {
               return;        
           }
